...
public class TestCraps
{
	 ...
	 * object that is rolled when game.play() is called. This returns true if the
	 * game is a win, false otherwise.
	 */
	...
	/**
	 * Field <code>numPlays</code> counts the total number of individual games to
	 * play.
	 */
	private int numPlays;

	/**
	 * int array field <code>winSteps</code> tracks number of wins w after exactly k
	 * rolls: <code>winsteps[k]==w </code>, out of <code>numPlays</code> total
	 * plays.
	 */
	...
	/**
	 * int array field <code>lossSteps</code> racks number of losses l after exactly
	 * k rolls: <code>lossSteps[k]==l</code>, out of <code>numPlays</code> total
	 * plays.
	 */
	...
	/**
	 * Instance method <code>public void play(int)</code> plays n games of craps,
	 * tracking the results of each: number of total wins out of n, and for each
	 * win, how many games end in a win/loss after exactly k plays: winSteps[k],
	 * lossSteps[k]
	 * 
	 * @param n
	...
	/**
	 * Instance method <code>public void reportStats</code> prints out final value
	 * of number of how many games end in a win/loss after exactly k plays:
	 * winSteps[k], lossSteps[k]total wins out of n, and
	 * 
	 ...
	 * TestCraps.main():
	 * 
	 * Build a TestCraps object, play NUM_TO_PLAY games, gathering and reporting the
	 * results.
	 * 
